		...
		<tr>
			...
			<td class="formSubTitleNoLeft" align="right">
				<c:if test="${param.pocTitle ne 'Primary Point of Contact' }">
					<a href="#"
					onclick="removeComponent(submitPointOfContactForm, 'submitPointOfContact', ${param.orgIndex}, 'removePointOfContact');return false;">
...
<%--				<html:text property="${param.pocBean}.organization.postalCode" size="10" />--%>
			...
			<td class="rightLabel" colspan="2">
<%--				<html:text property="${param.pocBean}.organization.country" size="40" />--%>
				&nbsp;
			</td>
		</tr>
		...
		<tr>
			...
			<td class="rightLabel" colspan="5">
				<html:select property="${param.pocBean}.visibilityGroups" multiple="true"
					size="6">
<%--					<html:options name="allVisibilityGroups" />--%>
				</html:select>
				<br>
