	...
	<tr>
		...
		<td class="label">
			<c:choose>
				...
				<c:otherwise>
					${thisForm.map.achar.instrumentConfigBean.instrumentBean.type}&nbsp;
				</c:otherwise>
			</c:choose>
		</td>
		<td class="label">
	...
	<tr>
		...
		<td class="rightLabel" colspan="3">
			<c:choose>
				...
				<c:otherwise>
						${thisForm.map.achar.instrumentConfigBean.instrumentBean.manufacturer}&nbsp;
				</c:otherwise>
			</c:choose>
		</td>
	</tr>
	<tr>
		...
		<td class="rightLabel" colspan="3">
			<c:choose>
				...
				<c:otherwise> 
						${thisForm.map.achar.instrumentConfigBean.description}&nbsp; 
					</c:otherwise>
			</c:choose>
		</td>
	</tr>
