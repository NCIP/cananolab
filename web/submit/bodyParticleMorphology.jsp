					...
					<tbody>
						...
						<tr>
							<td class="completeLabel" colspan="4">
								<c:forEach var="achar.derivedBioAssayData" items="${nanoparticleMorphologyForm.map.achar.derivedBioAssayData}" varStatus="status">
									<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
										<tbody>
											<tr class="topBorder">
											...
											<tr>
												...
												<td class="rightLabel" colspan="3">
													<c:choose>
														...
														<c:otherwise>
						${nanoparticleMorphologyForm.map.achar.derivedBioAssayData[status.index].type}&nbsp;
					</c:otherwise>
													</c:choose>
												</td>
											</tr>
											<tr>
													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="characterizationFile${status.index}">
																...
																<a href="nanoparticleMorphology.do?dispatch=download&amp;fileId=${fileId}"><bean:write name="characterizationFile${status.index}" property="name" /></a>
															</logic:present>
												...
												Click on "Load File" button
														...
														<c:otherwise>
						${nanoparticleMorphologyForm.map.achar.derivedBioAssayData[status.index].file.name}&nbsp;
					</c:otherwise>
													</c:choose>													
												</td>
												<td class="rightLabel" colspan="2">
