	...
	<table width="100%" align="center">
		...
		<tr>
			<td colspan="2">				
				...
				<jsp:include page="/submit/bodySharedCharacterizationSummary.jsp?formName=nanoparticleStabilityForm"/>
				<jsp:include page="/submit/bodySharedCharacterizationInstrument.jsp?formName=nanoparticleStabilityForm" />
				...
				<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
					<tbody>
						...
						${nanoparticleStabilityForm.map.achar.derivedBioAssayDataList[status.index].type}&nbsp;
											...
											<jsp:include page="/submit/bodySharedCharacterizationFile.jsp?chartInd=${chartInd}&formName=nanoparticleStabilityForm&actionName=nanoparticleStability" />
