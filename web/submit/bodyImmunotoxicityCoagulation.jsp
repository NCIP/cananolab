					...
					<tbody>
						...
						<tr>
							<td class="completeLabel" colspan="4">
								<c:forEach var="achar.derivedBioAssayData" items="${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData}" varStatus="status">
									<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
										<tbody>
											<tr class="topBorder">
											...
											<tr>
												<td class="leftLabel">
													<strong>Coagulation Time</strong>
												</td>
												<td class="rightLabel" colspan="3">
    												...
    												<c:choose>
        												<c:when test="${canUserUpdateParticle eq 'true'}">
															<html:select name="achar.derivedBioAssayData" property="datumList[0].valueUnit" indexed="true">
																<html:options name="allTimeUnits" />
															</html:select>
        												</c:when>
        												<c:otherwise>
															${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData[status.index].datumList[0].valueUnit}&nbsp;
        												</c:otherwise>
    												</c:choose>
												</td>
											</tr>
													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="achar.derivedBioAssayData" property="datumList[0].control">
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityCoagulation', ${status.index})" checked />Yes
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityCoagulation', ${status.index})" />No
															</logic:present>
															<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].control">
																<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityCoagulation', ${status.index})" />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityCoagulation', ${status.index})" />No
																</logic:notPresent>
																<logic:present name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	...
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityCoagulation', ${status.index})" />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityCoagulation', ${status.index})" checked />No
																</logic:present>
															</logic:notPresent>
														</c:when>
														<c:otherwise>
															<logic:present name="achar.derivedBioAssayData" property="datumList[0].control">
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityCoagulation', ${status.index})" disabled checked />Yes
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityCoagulation', ${status.index})" disabled />No
															</logic:present>
															<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].control">
																<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityCoagulation', ${status.index})" disabled />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityCoagulation', ${status.index})" disabled />No
																</logic:notPresent>
																<logic:present name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	...
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityCoagulation', ${status.index})" disabled />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityCoagulation', ${status.index})" disabled checked />No
																</logic:present>
															</logic:notPresent>
														</c:otherwise>
													</c:choose>
																...
																<tr>
																	...
																	<td class="label">
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[0].value}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
    																	&nbsp;&nbsp;&nbsp;
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[0].valueUnit}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
																	</td>
																	<td class="leftLabel">
    	    															...
    	    															<c:choose>
        																	<c:when test="${canUserUpdateParticle eq 'true'}">
																				<html:text name="achar.derivedBioAssayData" property="datumList[0].conditionList[1].value" indexed="true"/>
 																				&nbsp; ${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].valueUnit}	
        																	</c:when>
        																	<c:otherwise>
																				${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].value}
 																				&nbsp; ${invitroImmunotoxicityCoagulationForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].valueUnit}	
        																	</c:otherwise>
    																	</c:choose>
																	</td>
