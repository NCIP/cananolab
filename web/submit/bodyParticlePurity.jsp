	...
	<table width="100%" align="center">
		<tr>
			...
			<td align="right" width="15%">
				<a href="javascript:openHelpWindow('webHelp/caLAB_0.5/index.html?single=true&amp;context=caLAB_1.0_OH&amp;topic=nano_purity_help')" class="helpText">Help</a>
			</td>
		</tr>
		<tr>
			<td colspan="2">
					...
					<tbody>
						...
						<tr>
							...
							<td class="rightLabel" colspan="2">
								...
								<c:choose>
									<c:when test="${canUserUpdateParticle eq 'true'}">
										<input type="button" onclick="javascript:updateCharts(this.form, 'nanoparticlePurity')" value="Update Images">
									</c:when>
								</c:choose>
							</td>
						</tr>
