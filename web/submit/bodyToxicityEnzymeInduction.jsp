													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="characterizationFile${status.index}">
																...
																<a href="invitroToxicityEnzymeInduction.do?dispatch=download&amp;fileId=${fileId}"><bean:write name="characterizationFile${status.index}" property="displayName" /></a>
															</logic:present>
																...
																<tr>
																	...
																	<td class="label">
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[2].value}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
    																	&nbsp;&nbsp;&nbsp;
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[2].valueUnit}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
																	</td>
																</tr>
