					...
					<tbody>
						...
						<tr>
							<td class="completeLabel" colspan="4">
								<c:forEach var="achar.table" items="${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData}" varStatus="status">
									<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
										<tbody>
											<tr class="topBorder">
											...
											<tr>
												<td class="leftLabel">
													<strong>EnzymeInduction Percentage</strong>
												</td>
												<td class="rightLabel" colspan="3">
													<c:choose>
														...
														<c:otherwise>
															${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].value} ${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].valueUnit}&nbsp;
														</c:otherwise>
													</c:choose>
												</td>
											</tr>
											<tr>
												<td class="leftLabel">
													...
													<% if ( isControl == null ) { %>
													&nbsp;&nbsp;&nbsp;
													<input type="radio" name="isControl" value="Yes" onclick="javascript:addControlConditions(this.form, 'invitroToxicityEnzymeInduction', ${status.index})" />Yes
													&nbsp;&nbsp;&nbsp;
													<input type="radio" name="isControl" value="No" onclick="javascript:addControlConditions(this.form, 'invitroToxicityEnzymeInduction', ${status.index})"  />No
													&nbsp;&nbsp;&nbsp;&nbsp;
													<% } else {%>
													&nbsp;&nbsp;&nbsp;
													<input type="radio" name="isControl" value="Yes" onclick="javascript:addControlConditions(this.form, 'invitroToxicityEnzymeInduction', ${status.index})" <% if ( isControl.equals("true") ) { %> checked disabled <% } else { %> disabled <% } %> />Yes
													&nbsp;&nbsp;&nbsp;
													<input type="radio" name="isControl" value="No" onclick="javascript:addControlConditions(this.form, 'invitroToxicityEnzymeInduction', ${status.index})"  <% if ( isControl.equals("false") ) { %> checked disabled <% } else { %> disabled <% } %> />No
													&nbsp;&nbsp;&nbsp;&nbsp;
													<% } %>
												</td>
											</tr>
												...
												<tr>
													...
													<td class="label">
														<c:choose>
															...
															<c:otherwise>
																${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].numberOfConditions}&nbsp;
															</c:otherwise>
														</c:choose>
													</td>
													<td class="rightLabel" colspan="2">
														...
														<c:choose>
															<c:when test="${canUserUpdateParticle eq 'true'}">
																<input type="button" onclick="javascript:updateConditions(this.form, 'invitroToxicityEnzymeInduction', ${status.index})" value="Update Conditions">
															</c:when>
														</c:choose>
													</td>
												</tr>
											...
											%>
											<c:forEach var="achar.table" items="${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList}" varStatus="cstatus">
												<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
													<tbody>
														<tr class="topBorder">
															<td class="formSubTitle" colspan="4">
														...
														<tr>
															...
															<td class="label">
    															<c:choose>
        															...
        															<c:otherwise>
																		${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].condition[cstatus.index].type}&nbsp;
        															</c:otherwise>
    															</c:choose>
															</td>
															<td class="label">
															...
															<td class="rightLabel">
    															<c:choose>
        															...
        															<c:otherwise>
																		${invitroToxicityEnzymeInductionForm.map.achar.derivedBioAssayData[status.index].datumList[0].condition[cstatus.index].value}&nbsp;
        															</c:otherwise>
    															</c:choose>
															</td>
														</tr>
