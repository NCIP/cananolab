	...
	<table width="100%" align="center">
		<tr>
			<td>
				<h4>
					<br>
					Invitro Characterization - Toxicity - EnzymeInduction
				</h4>
			</td>
										...
										<tbody>
											...
											<tr>
												<td class="leftLabel">
													...
													&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="button" onclick="javascript:addControlConditions(this.form, 'invitroToxicityEnzymeInduction', ${status.index})" value="Add">
												</td>
											</tr>
