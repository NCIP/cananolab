					...
					<tbody>
						...
						${invitroImmunotoxicityProteinBindingForm.map.achar.numberOfDerivedBioAssayData}&nbsp;
							...
							<td class="rightLabel" colspan="2">
								...
								<c:choose>
									<c:when test="${canUserUpdateParticle eq 'true'}">
										<input type="button" onclick="javascript:updateProteinBinding()" value="Update Graphs">
									</c:when>
								</c:choose>
							</td>
						</tr>
											...
											<tr>
												...
												<td class="rightLabel" colspan="3">
													<c:choose>
														...
														<c:otherwise>
						${invitroImmunotoxicityProteinBindingForm.map.achar.characterizationTables[status.index].type}&nbsp;
					</c:otherwise>
													</c:choose>
												</td>
											</tr>
						...
						${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].file.name}&nbsp;
											...
											<tr>
												...
												<td class="label">
													...
													&nbsp; ${invitroImmunotoxicityProteinBindingForm.map.achar.characterizationTables[status.index].tableDataList[0].valueUnit}	
														</c:when>
														<c:otherwise>
						${invitroImmunotoxicityProteinBindingForm.map.achar.characterizationTables[status.index].tableDataList[0].value} ${nanoparticleSizeForm.map.achar.characterizationTables[status.index].tableDataList[0].valueUnit}&nbsp;
					</c:otherwise>
													</c:choose>
												</td>
												<td class="label">
												...
												<td class="rightLabel">
													...
													&nbsp; ${invitroImmunotoxicityProteinBindingForm.map.achar.characterizationTables[status.index].tableDataList[1].valueUnit}
														</c:when>
														<c:otherwise>
						${invitroImmunotoxicityProteinBindingForm.map.achar.characterizationTables[status.index].tableDataList[1].value} ${nanoparticleSizeForm.map.achar.characterizationTables[status.index].tableDataList[1].valueUnit}&nbsp;
					</c:otherwise>
													</c:choose>
												</td>
											</tr>
