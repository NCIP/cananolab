												...
												<tr>
													...
													<td class="label">
														<c:choose>
															...
															<c:otherwise>
																${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].numberOfConditions}&nbsp;
															</c:otherwise>
														</c:choose>
													</td>
													<td class="rightLabel" colspan="2">
														...
														<c:choose>
															<c:when test="${canUserUpdateParticle eq 'true'}">
																<input type="button" onclick="javascript:updateConditions(this.form, 'invitroImmunotoxicityProteinBinding', ${status.index})" value="Update Conditions">
															</c:when>
														</c:choose>
													</td>
												</tr>
