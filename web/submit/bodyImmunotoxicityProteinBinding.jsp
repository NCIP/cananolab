	...
	<table width="100%" align="center">
		<tr>
			<td>
				<h4>
					<br>
					Invitro Characterization - Immunotoxicity - Plasma Protein Binding
				</h4>
			</td>
		...
		<tr>
			<td colspan="2">
				<h5 align="center">
					${invitroImmunotoxicityProteinBindingForm.map.particleName} (${invitroImmunotoxicityProteinBindingForm.map.particleType})
				</h5>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<c:set var="thisForm" value="${invitroImmunotoxicityProteinBindingForm}" />
					...
					<tbody>
						...
						<tr>
							...
							<td class="rightLabel" colspan="2">
								...
								<c:choose>
									<c:when test="${canUserUpdateParticle eq 'true'}">
										<input type="button" onclick="javascript:update(this.form, 'invitroImmunotoxicityProteinBinding')" value="Update">
									</c:when>
								</c:choose>
							</td>
						</tr>
						...
						<tr>
							<td class="completeLabel" colspan="4">
								<c:forEach var="achar.derivedBioAssayData" items="${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData}" varStatus="status">
									<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
										<tbody>
											<tr class="topBorder">
													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="characterizationFile${status.index}">
																...
																<a href="invitroImmunotoxicityProteinBinding.do?dispatch=download&amp;fileId=${fileId}"><bean:write name="characterizationFile${status.index}" property="displayName" /></a>
															</logic:present>
													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="achar.derivedBioAssayData" property="datumList[0].control">
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityProteinBinding', ${status.index})" checked />Yes
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityProteinBinding', ${status.index})" />No
															</logic:present>
															<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].control">
																<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityProteinBinding', ${status.index})" />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityProteinBinding', ${status.index})" />No
																</logic:notPresent>
																<logic:present name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	...
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityProteinBinding', ${status.index})" />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityProteinBinding', ${status.index})" checked />No
																</logic:present>
															</logic:notPresent>
														</c:when>
														<c:otherwise>
															<logic:present name="achar.derivedBioAssayData" property="datumList[0].control">
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityProteinBinding', ${status.index})" disabled checked />Yes
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityProteinBinding', ${status.index})" disabled />No
															</logic:present>
															<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].control">
																<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityProteinBinding', ${status.index})" disabled />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityProteinBinding', ${status.index})" disabled />No
																</logic:notPresent>
																<logic:present name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	...
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityProteinBinding', ${status.index})" disabled />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityProteinBinding', ${status.index})" disabled checked />No
																</logic:present>
															</logic:notPresent>
														</c:otherwise>
													</c:choose>
																...
																<tr>
																	<td class="leftLabel" colspan="2">
    																	...
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].control.name}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
																	</td>
																...
																<tr>
																	...
																	<td class="label">
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[0].value}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
    																	&nbsp;&nbsp;&nbsp;
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[0].valueUnit}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
																	</td>
																	<td class="leftLabel">
    	    															...
    	    															<c:choose>
        																	<c:when test="${canUserUpdateParticle eq 'true'}">
																				<html:text name="achar.derivedBioAssayData" property="datumList[0].conditionList[1].value" indexed="true"/>
 																				&nbsp; ${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].valueUnit}	
        																	</c:when>
        																	<c:otherwise>
																				${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].value}
 																				&nbsp; ${invitroImmunotoxicityProteinBindingForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].valueUnit}	
        																	</c:otherwise>
    																	</c:choose>
																	</td>
