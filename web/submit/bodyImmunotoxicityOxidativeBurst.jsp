	...
	<table width="100%" align="center">
		<tr>
			<td>
				<h4>
					<br>
					Invitro Characterization - Immunotoxicity - Oxidative Burst
				</h4>
			</td>
					...
					<tbody>
						...
						<tr>
							<td class="completeLabel" colspan="4">
								<c:forEach var="achar.derivedBioAssayData" items="${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData}" varStatus="status">
									<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
										<tbody>
											<tr class="topBorder">
													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="characterizationFile${status.index}">
																...
																<a href="invitroImmunotoxicityOxidativeBurst.do?dispatch=download&amp;fileId=${fileId}"><bean:write name="characterizationFile${status.index}" property="displayName" /></a>
															</logic:present>
											...
											<tr>
												<td class="leftLabel">
													<strong>Oxidative Burst Percentage</strong>
												</td>
												<td class="rightLabel" colspan="3">
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<html:text name="achar.derivedBioAssayData" property="datumList[0].value" indexed="true" />
															&nbsp; ${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData[status.index].datumList[0].valueUnit}	
														</c:when>
														<c:otherwise>
													...
													<c:choose>
														<c:when test="${canUserUpdateParticle eq 'true'}">
															<logic:present name="achar.derivedBioAssayData" property="datumList[0].control">
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" checked />Yes
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" />No
															</logic:present>
															<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].control">
																<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" />No
																</logic:notPresent>
																<logic:present name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	...
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" checked />No
																</logic:present>
															</logic:notPresent>
														</c:when>
														<c:otherwise>
															<logic:present name="achar.derivedBioAssayData" property="datumList[0].control">
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" disabled checked />Yes
																&nbsp;&nbsp;&nbsp;
																<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" disabled />No
															</logic:present>
															<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].control">
																<logic:notPresent name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" disabled />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" disabled />No
																</logic:notPresent>
																<logic:present name="achar.derivedBioAssayData" property="datumList[0].conditionList">
																	...
																	<input type="radio" name="isControl${status.index}" value="Yes" onclick="javascript:addControlConditions(this.form, 'addControl', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" disabled />Yes
																	&nbsp;&nbsp;&nbsp;
																	<input type="radio" name="isControl${status.index}" value="No" onclick="javascript:addControlConditions(this.form, 'addConditions', 'invitroImmunotoxicityOxidativeBurst', ${status.index})" disabled checked />No
																</logic:present>
															</logic:notPresent>
														</c:otherwise>
													</c:choose>
																...
																<tr>
																	...
																	<td class="label">
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[0].value}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
    																	&nbsp;&nbsp;&nbsp;
    																	<c:choose>
        																	...
        																	<c:otherwise>
																				${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[0].valueUnit}&nbsp;
        																	</c:otherwise>
    																	</c:choose>
																	</td>
																	<td class="leftLabel">
    	    															...
    	    															<c:choose>
        																	<c:when test="${canUserUpdateParticle eq 'true'}">
																				<html:text name="achar.derivedBioAssayData" property="datumList[0].conditionList[1].value" indexed="true"/>
 																				&nbsp; ${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].valueUnit}	
        																	</c:when>
        																	<c:otherwise>
																				${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].value}
 																				&nbsp; ${invitroImmunotoxicityOxidativeBurstForm.map.achar.derivedBioAssayData[status.index].datumList[0].conditionList[1].valueUnit}	
        																	</c:otherwise>
    																	</c:choose>
																	</td>
