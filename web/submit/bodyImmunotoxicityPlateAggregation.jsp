					...
					<tbody>
						...
						<tr>
							...
							<td class="label">
								<c:choose>
									...
									<c:otherwise>
						${invitroImmunotoxicityPlateAggregationForm.map.achar.numberOfCharacterizationTables}&nbsp;
					</c:otherwise>
								</c:choose>
							</td>
						...
						<tr>
							<td class="completeLabel" colspan="4">
								<c:forEach var="achar.table" items="${invitroImmunotoxicityPlateAggregationForm.map.achar.characterizationTables}" varStatus="status">
									<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
										<tbody>
											<tr class="topBorder">
						...
						${invitroImmunotoxicityPlateAggregationForm.map.achar.characterizationTables[status.index].type}&nbsp;
											...
											<tr>
												...
												Click on "Load File" button
														...
														<c:otherwise>
						${invitroImmunotoxicityPlateAggregationForm.map.achar.characterizationTables[status.index].file.name}&nbsp;
					</c:otherwise>
													</c:choose>													
												</td>
												<td class="rightLabel" colspan="2">
											...
											<tr>
												...
												<td class="rightLabel" colspan="3">
													<c:choose>
														...
														<c:otherwise>
						${invitroImmunotoxicityPlateAggregationForm.map.achar.characterizationTables[status.index].tableDataList[2].value}&nbsp;
					</c:otherwise>
													</c:choose>
												</td>
											</tr>
