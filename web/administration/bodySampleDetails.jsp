...
<blockquote>
	<%--show sample details --%>
	<logic:equal parameter="showAliquot" value="false">
	...
	<logic:equal parameter="showAliquot" value="true">
		<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="90%" align="center" summary="" border="0">
			<tbody>
				<tr class="topBorder">
					<td class="dataTablePrimaryLabel" colspan="2">
				...
				<tr>
					...
					<td class="formField" width="72%">
						<span class="formMessage"><span style="FONT-SIZE: 8pt"><bean:write name="aliquot" property="sample.sampleId" /></span></span>
					</td>
				</tr>
