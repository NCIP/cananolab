		...
		<tr>
			<td colspan="2">
				...
				<table width="100%" border="0" align="center" cellpadding="3"
					...
					<tr>
						<td class="leftLabel">
							<strong>Nanomaterial Entity Type*</strong>
						</td>
						<td class="rightLabel">
							<c:choose>
								<c:when
									test="${param.dispatch eq 'setup' || empty nanomaterialEntityForm.map.entity.type}">
				...
				<br>
				<c:choose>
					<c:when test="${!empty nanomaterialEntityForm.map.entity.type}">
						<c:set var="entityType"
							value="${nanomaterialEntityForm.map.entity.type}" scope="page" />
						<%
						...
						%>
						<jsp:include
							page="/sample/composition/nanomaterialEntity/body${entityClass}Info.jsp" />
					</c:when>
				</c:choose>
							...
							<td class="completeLabel" colspan="4">
								<table border="0" width="100%">
									<tr>
										<td valign="bottom">
											<a href="#"
												onclick="javascript:addComponent(nanomaterialEntityForm, 'nanomaterialEntity', 'addComposingElement'); return false;">
													...
													<tbody>
														<tr>
															...
															<td class="formSubTitleNoLeft" align="right">
																<a href="#"
																	onclick="removeComponent(nanomaterialEntityForm, 'nanomaterialEntity', ${ind}, 'removeComposingElement');return false;">
														...
														<tr>
															<td valign="bottom" class="leftLabel">
																<a href="#"
																	onclick="javascript:addChildComponent(nanomaterialEntityForm, 'nanomaterialEntity', ${ind}, 'addInherentFunction'); return false;">
																	<span class="addLink2">Add Inherent Function</span> </a>
															</td>
															<td colspan="3" class="rightLabel">
																<jsp:include
																	page="/sample/composition/nanomaterialEntity/bodyFunctionUpdate.jsp">
									...
									<td width="490" height="32">
										<div align="right">
											<div align="right">
												...
												<c:set var="origUrl" value="${actionName}.do?sampleId=${sampleId}&submitType=${submitType}&page=0&dispatch=setup&location=${location}" />
												<c:if test="${!empty dataId}">
													<c:set var="origUrl" value="${actionName}.do?sampleId=${sampleId}&submitType=${submitType}&page=0&dispatch=setupUpdate&location=${location}&dataId=${dataId}" />
												</c:if>
