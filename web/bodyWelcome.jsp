...
<tr>
 	<td align="right">
 		<a href="javascript:openHelpWindow('webHelp/index.html?single=true&amp;context=caNanoLab&amp;topic=welcome_workflow')" class="helpText">Help</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 	</td>
</tr>
<tr>
	<td class="welcomeContent" valign="top">	
			...
			secure fashion. The diagram below describes the caNanoLab functionality:
			<br><br>
