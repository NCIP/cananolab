	...
	<table width="100%" align="center">
		<tr>
			...
			<td align="right" width="15%">
				<a
					href="javascript:openHelpWindow('webHelp/index.html?single=true&amp;context=caNanoLab&amp;topic=${nanoparticleFunctionForm.map.function.displayType}_help')"
											...
											<c:when test="${canCreateNanoparticle eq 'true'}">
												...
												<td>
													<logic:iterate id="linkage" name="nanoparticleFunctionForm"
														...
														<jsp:include
															page="/particle/function/bodyParticleFunctionLinkage.jsp">
											...
											<c:otherwise>
												...
												<td>
													<logic:iterate id="linkage" name="nanoparticleFunctionForm"
														property="function.linkages" indexId="linkageInd">
														<jsp:include
															page="/particle/function/bodyParticleFunctionLinkageReadOnly.jsp">
															<jsp:param name="linkageInd" value="${linkageInd}" />
														</jsp:include>
														<br>
													</logic:iterate>
