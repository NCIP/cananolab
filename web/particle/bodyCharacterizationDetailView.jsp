...
<table width="100%" align="center">
	<tr>
		...
		<td align="right" width="15%">
			<a
				href="javascript:openHelpWindow('webHelp/index.html?single=true&amp;context=caNanoLab&amp;topic=${nanoparticleCharacterizationForm.map.achar.dispatchActionName}_detail_view_help')"
