	...
	<table width="100%" align="center">
		...
		<tr>
			<td colspan="2">
				...
				<table class="topBorderOnly" cellspacing="0" cellpadding="3"
					...
					<tbody>
						...
						<tr>
							<td class="formLabel">
								<div align="justify">
									<strong> Sample ID Prefix(<bean:write
											name="createSampleForm" property="configuredSampleNamePrefix" />X)
										*<span class="formField"><span class="formFieldWhite"><html:text
													property="sampleNamePrefix" size="15" /> </span> </span> &nbsp; &nbsp;
										Sample Type* <span class="formFieldWhite"> <html:select
												property="sampleType">
												<option/>
								...
								<div align="justify">
									<strong>Description <br> <span class="formField"><span
											class="formFieldWhite"><html:textarea
													property="sampleDescription" cols="70" /> </span> </span> </strong>
								</div>
							</td>
						</tr>
						<tr>
								...
								<div align="justify">
									<strong>Source* <span class="formFieldWhite"> <html:select
												...
												<html:options name="allSampleSources" />
													...
													property="sourceSampleId" size="10" /> </span> &nbsp; &nbsp; 
									</strong>
								</div>
							</td>
						</tr>
							...
							<td class="formLabelWhite">
								<div align="justify">
									<strong>Date Received <html:text
											property="dateReceived" size="9" /> <span
						...
						<tr>
							<td class="formLabel">
								<div align="justify">
									<strong>Lot ID*&nbsp; <html:text property="lotId"
											size="5" /> &nbsp; &nbsp; &nbsp; Lot Description <span
										class="formFieldWhite"><html:text
												property="lotDescription" size="50" /> </span> </strong>
								</div>
							</td>
						</tr>
							...
							<td class="formLabelWhite">
								<div align="justify">
									<strong>Solubility <br> <span
										class="formFieldWhite"><html:textarea
												property="solubility" cols="70" /> </span> &nbsp;</strong>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td class="formLabel">
								<div align="justify">
									<strong>Number of Containers*<span
										class="formFieldWhite"> &nbsp; <html:text
												property="numberOfContainers" size="2" /> &nbsp; 
									</strong>(Please click on "Update Sample Containers" button below if
									number of containers has been changed.)
								</div>
							</td>
						</tr>
						<tr>
							<td class="formLabelWhite">
								<div align="left">
									...
									<span class="formField"><span class="formFieldWhite">
											<html:textarea property="generalComments" cols="70" /> </span> </span>
								</div>
							</td>
						</tr>
				...
				<c:forEach var="containers"
					items="${createSampleForm.map.containers}" varStatus="status">
					<table class="topBorderOnly" cellspacing="0" cellpadding="3"
						width="100%" align="center" summary="" border="0">
						<tbody>
							<tr class="topBorder">
								<td class="formTitle" width="30%">
									<div align="justify">
										...
										<html:hidden name="containers" indexed="true"
											property="containerName" value="${status.index+1}" />
										<c:choose>
								...
								<td class="formLabel">
									<div align="justify">
										<strong>Container Type* <span class="formFieldWhite">
												<html:select name="containers" indexed="true"
								...
								<td class="formLabelWhite style1">
									<div align="left">
										<strong>Quantity <span class="formFieldWhite"><html:text
													size="5" name="containers" indexed="true"
													property="quantity" /> </span><span class="formFieldWhite">
												<html:select name="containers" indexed="true"
													...
													size="8" name="containers" indexed="true"
													property="concentration" /> </span><span class="formFieldWhite">
												<html:select name="containers" indexed="true"
													...
													size="8" name="containers" indexed="true" property="volume" />
										</span><span class="formFieldWhite"> <html:select
													name="containers" indexed="true" property="volumeUnit">
													<option/>
													<html:options name="sampleContainerInfo"
							...
							<tr>
								<td class="formLabel">
									<div align="justify">
										<strong>Diluents/Solvent <html:text name="containers"
												indexed="true" property="solvent" size="10" /> &nbsp;
											&nbsp; &nbsp; Safety Precautions <html:text name="containers"
												indexed="true" property="safetyPrecaution" size="30" />
											&nbsp; &nbsp; &nbsp;</strong>
									</div>
								</td>
							</tr>
								...
								<td class="formLabelWhite style1">
									<div align="justify">
										<strong>Storage Conditions <span class="formField"><html:text
													name="containers" indexed="true"
													property="storageCondition" size="50" /> </span> </strong>
									</div>
							...
							<tr>
								<td class="formLabel">
									<strong>Storage Location<br> <br>
										<table class="topBorderOnly" cellspacing="0" cellpadding="3"
											align="left" summary="" border="0" width="90%">
											<strong>
											<tr>
							...
							<tr>
								<td class="formLabelWhite">
									<div align="left">
										...
										<br>
										<span class="formField"><span class="formFieldWhite">
												<html:textarea name="containers" indexed="true"
													property="containerComments" cols="70" /> </span> </span>
										<br>
									</div>
								</td>
							</tr>
				...
				<table cellspacing="0" cellpadding="3" width="100%" align="center"
					...
					<tbody>
						<tr>
							...
							<td align="right">
								<table height="32" cellspacing="0" cellpadding="4 align="
									right"
															order="0">
									<tbody>
										<tr>
											<td height="32">
												<div align="right">
													<input type="button" value="Update Containers"
														onClick="javascript:refreshContainers();">
