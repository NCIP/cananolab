...
function handleReset()
{
	...
	document.createAssayRunForm.runBy.value = "";
	document.createAssayRunForm.runDate.value = "";
	for (index=document.createAssayRunForm.assignedAliquot.length-1; index>=0; index--) {			
		document.createAssayRunForm.assignedAliquot[index] = null;
	}
}
</script>
<h2>
<strong>Create Run for Assay <%= request.getParameter("assayName") %></strong>
</h2>
	<blockquote>
		<html:errors />
	...
	<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="topBorderOnly" summary="">
		...
		<tr>
			...
			<td class="formLabelWhite">
					<div align="justify">
						<span class="formFieldWhite"><html:textarea property="runComment" cols="40" /></span></span></strong>
					</div>
				</td>
		</tr>
