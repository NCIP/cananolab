...
<html:form action="/preMaskAliquot">
	<table class="topBorderOnly" cellspacing="0" cellpadding="3" width="80%" align="center" summary="" border="0">
		<tbody>
			<tr class="topBorder">
	...
	<br>
	<table border="0" width="80%" align="center" cellpadding="3" cellspacing="0" class="topBorderOnly" summary="">
		<tr>
			<td width="30%">
