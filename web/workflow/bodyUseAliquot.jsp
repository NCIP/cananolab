														...
														<td class="formField">
															<div align="left">
																* Hold down the shift key for multiple selections.
																<br>
																<span class="formField" align="left"><span class="mainMenu"><span class="formMessage"><strong> <select multiple size="3" name="aliquotIds" style="width:100">
																					<option value="12">
																						NCL-3-1
																					</option>
																					<option value="54">
																				...
																				</select> </strong></span></span></span> <span class="formFieldWhite"> </span>
															</div>
														</td>
													</tr>
												</table>
