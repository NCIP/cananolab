...
<table width="100%" align="center">
	<tr>
		...
		<td align="right" width="15%">
			<a href="javascript:openHelpWindow('webHelp/index.html?single=true&amp;context=caLAB_1.0_OH&amp;topic=nano_search_results_help')" class="helpText">Help</a>&nbsp;&nbsp; <a href="searchNanoparticle.do?dispatch=setup" class="helpText">back</a>
		</td>
	</tr>
	<tr>
		<td colspan="2">
