...
<html:form action="remoteSearchReport">
	<table align="center" width="100%">
		<tr>
			<td>
				<h3>
					<br>
					Remote Search for Reports
				</h3>
			</td>
			<td align="right" width="25%">
				<%--<a href="advancedNanoparticleSearch.do" class="helpText">Advanced Search</a> &nbsp; &nbsp; --%>
				<a href="javascript:openHelpWindow('webHelp/index.html?single=true&amp;context=caNanoLab&amp;topic=remote_reports_search_help')" class="helpText">Help</a>
			</td>
		</tr>
		<tr>
			<td colspan="2">
						...
						<td>
							...
							<table border="0" align="right" cellpadding="4" cellspacing="0">
								<tr>
									<td>
										<div align="right">
											<input type="button" value="Reset" onClick="javascript:location.href='remoteSearchReport.do?dispatch=setup&page=0'">
