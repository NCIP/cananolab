                    ...
                    <tr>
                      <td height="100%">
                        <table summary="" cellpadding="0" cellspacing="0" border="0" height="100%">
                          <tr>
                            <td valign="top"><img src="images/bannerhome.jpg" width="600" height="140">                              <table summary="" cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
                                <tr>
                                  <td class="welcomeTitle" height="20">WELCOME TO caLAB </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td valign="top">
                                    <table summary="" cellpadding="2" cellspacing="0" border="0" width="100%" class="sidebarSection">
                                      <tr>
                                        <td class="sidebarTitle" height="20">USER LOGIN </td>
                                      </tr>
                                      <tr>
                                        <td class="sidebarContent">
                                          <table cellpadding="2" cellspacing="0" border="0">
                                            <tr>
                                              <td class="sidebarLogin" align="right"><label for="loginID">EMAIL</label></td>
                                              <td class="formFieldLogin"><input class="formField" type="text" name="loginID2" size="14" /></td>
                                            </tr>
                                            <tr>
                                              <td class="sidebarLogin" align="right"><label for="password">PASSWORD</label></td>
                                              <td class="formFieldLogin"><input class="formField" type="password" name="password2" size="14" /></td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
                                              <td><input name="submit2" type="submit" class="actionButton" value="Login" /></td>
                                            </tr>
                                            <tr>
                                              <td colspan="2"><a href="#" class="formMessage">Create an Account<br>
                                                </a><a href="#" class="formMessage">
