			...
			<table width="100%" border="0" align="center" cellpadding="3"
				...
				<tr>
					...
					<td class="formTitle"
						colspan="4">
						<div align="justify">
							${fn:toUpperCase("LOCAL")} NCL-23-1 - Publications
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="leftLabel">
						<a href="#">PMID: 18294836</a>
					</td>
					<td class="label">
						Lu W
					</td>
					<td class="label">
						<a href="#">Enhanced photoelectrochemical method for linear DNA hybridization detection...</a>
					</td>
					<td class="rightLabel">
						2008
					</td>
				...
				<tr>
					<td class="leftLabel">
						<a href="#">PMID: 14611662</a>
					</td>
					<td class="label">
						Mike Toler
					</td>
					<td class="label">
						<a href="#">NCL200710A FUNCTIONALIZED FULLERENES FOR CSIXTY INC</a>
					</td>
					<td class="rightLabel">
						2007
					</td>
				...
				<tr>
					<td class="leftLabel">
						<a href="#">DOI: 10.1109/GLOCOM.1995.502594</a>
					</td>
					<td class="label">
						Steve William
					</td>
					<td class="label">
						<a href="#">NCL200702A CERAMIDE LIPOSOMES FOR MARK KESTER PSU</a>
					</td>
					<td class="rightLabel">
						2008
					</td>
				...
				<tr>
					<td class="leftLabel">
						<a href="#">REPORT: DENDRITIC NANOTECHINOLOGIES</a>
					</td>
					<td class="label">
						Scott E. McNeil
					</td>
					<td class="label">
						<a href="#">DENDRITIC NANOTECHNOLOGIES</a>
					</td>
					<td class="rightLabel">
						2006
					</td>
