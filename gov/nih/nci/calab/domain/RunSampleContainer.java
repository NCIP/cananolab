...
public  class RunSampleContainer 
	implements java.io.Serializable 
{
	private static final long serialVersionUID = 1234567890L;
			  ...
			  try {
			     java.util.List resultList = applicationService.search("gov.nih.nci.calab.domain.SampleContainer", thisIdSet);				 
		             if (resultList!=null && resultList.size()>0) {
		                sampleContainer = (gov.nih.nci.calab.domain.SampleContainer)resultList.get(0);
		             }
		          
			  } catch(Exception ex) 
			  { 
			      	System.out.println("RunSampleContainer:getSampleContainer throws exception ... ...");
			   		ex.printStackTrace(); 
			  }
	   ...
	   public void setSampleContainer(gov.nih.nci.calab.domain.SampleContainer sampleContainer){
		this.sampleContainer = sampleContainer;
			...
			public gov.nih.nci.calab.domain.DataStatus getDataStatus(){
			  ...
			  { 
			      	System.out.println("RunSampleContainer:getDataStatus throws exception ... ...");
			   		ex.printStackTrace(); 
			  }
			  return dataStatus;			
	   ...
	   public void setDataStatus(gov.nih.nci.calab.domain.DataStatus dataStatus){
		this.dataStatus = dataStatus;
			...
			public gov.nih.nci.calab.domain.Run getRun(){
			  ...
			  { 
			      	System.out.println("RunSampleContainer:getRun throws exception ... ...");
			   		ex.printStackTrace(); 
			  }
			  return run;	
