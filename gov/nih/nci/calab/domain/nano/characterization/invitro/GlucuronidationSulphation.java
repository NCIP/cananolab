...
public class GlucuronidationSulphation implements MetabolicStability {
	...
	public GlucuronidationSulphation() {
		super();
	...
	public String getName() {
		return METABOLIC_STABILITY_GLUCURONIDATION_SULPHATION;
	}
