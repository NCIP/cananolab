...
public class InputFile extends LabFile {
	...
	public gov.nih.nci.calab.domain.DataStatus getDataStatus() {
		...
		// gov.nih.nci.calab.domain.InputFile thisIdSet = new
		// gov.nih.nci.calab.domain.InputFile();
		...
		// } catch(Exception ex)
		// {
		// System.out.println("InputFile:getDataStatus throws exception ...
		// ...");
		// ex.printStackTrace();
		// }
		return dataStatus;
	...
	public gov.nih.nci.calab.domain.Run getRun() {
		...
		// } catch(Exception ex)
		// {
		// System.out.println("InputFile:getRun throws exception ... ...");
		// ex.printStackTrace();
		// }
		return run;
