...
public class NanoparticleMolecularWeightAction extends AbstractDispatchAction {
	...
	public ActionForward create(ActionMapping mapping, ActionForm form,
		...
		//molecularWeightChar.setCharacterizationSource(characterizationSource);
		//molecularWeightChar.setDescription(description);
		//molecularWeightChar.setViewTitle(viewTitle);
	...
	public ActionForward setupUpdate(ActionMapping mapping, ActionForm form,
		...
		MolecularWeightBean sChar = new MolecularWeightBean(aChar);
	...
	public void updateCharacterizationTables(MolecularWeightBean achar) {
