  ...
  .controller('SampleResultsCtrl', function (navigationFactory,groupsFactory,$rootScope,$scope,$http) {
    ...
    $scope.gridOptions = {
      ...
      columnDefs:[
          ...
          {field: 'functions', displayName: 'Functions', enableCellEdit: false, width:'16%'},
          {field: 'characterizations', displayName: 'Characterizations', enableCellEdit: false, width:'16%'},
          {field: 'dataAvailability', displayName: 'Date Availability', enableCellEdit: false, width:'10%'},
