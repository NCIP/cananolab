  ...
  .controller('SampleResultsCtrl', function (navigationFactory,groupsFactory,$rootScope,$scope,$http) {
    ...
    $scope.gridOptions = {
      ...
      columnDefs:[
          ...
          {field: 'functions', displayName: 'Functions', enableCellEdit: false, width:'15%',cellTemplate:'<div grid-list="functions">{{row.getProperty(col.field)}}</div>'},
          {field: 'characterizations', displayName: 'Characterizations', enableCellEdit: false, width:'15%', cellTemplate:'<div grid-list="characterizations">{{row.getProperty(col.field)}}</div>'},
          {field: 'dataAvailability', displayName: 'Date Availability', enableCellEdit: false, width:'12%'},
          {field: 'createdDate', displayName: 'Created Date', width:'8%', enableCellEdit: false}
          ]     
