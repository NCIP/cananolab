...
var app = angular.module('angularApp')
  ...
  .controller('SampleResultsCtrl', function (navigationFactory,groupsFactory,$rootScope,$scope,$http) {
    ...
    $scope.gridOptions = {
      ...
      columnDefs:[
          {field: 'sampleId', displayName: '', enableCellEdit: false,width:'5%',cellTemplate:"<div>View</div>"},
          {field: 'sampleName', displayName: 'Sample Name', enableCellEdit: false, width:'14%'},
          {field: 'pointOfContact', displayName: 'Primary Point of Contact',width:'18%', enableCellEdit: false,resizable:true,cellTemplate:'<div ng-bind-html="row.getProperty(col.field)" />'},
          {field: 'composition', displayName: 'Composition', enableCellEdit: false, width:'14%'},
          {field: 'functions', displayName: 'Functions', enableCellEdit: false, width:'15%'},
          {field: 'characterizations', displayName: 'Characterizations', enableCellEdit: false, width:'15%'},
          {field: 'dataAvailability', displayName: 'Date Availability', enableCellEdit: false, width:'12%'},
          {field: 'createdDate', displayName: 'Created Date', width:'7%', enableCellEdit: false}
          ]     
