...
var app = angular.module('angularApp')
  .controller('SampleResultsCtrl', function (sampleService,navigationService,groupService,utilsService,$scope,$rootScope,$filter,ngTableParams,$http,$location,$modal) {
    ...
    $scope.addToFavorites = function(sampleId, sampleName) {
        $scope.loader = true;
        
        $scope.favoriteBean = {"dataType" : "sample", "dataName" : sampleName, "dataId" : sampleId, "loginName" : $scope.loggedInUser.name};
