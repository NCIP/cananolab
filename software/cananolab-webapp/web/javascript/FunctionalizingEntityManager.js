...
var numberOfTargets; // number of unique targets in the cache, used to
// generate target id
...
function addTarget() {
	var antigen = {
		species : dwr.util.getValue("antigenSpecies")
	};
	...
	var target = {
		id : targetId,
		type : dwr.util.getValue("targetType"),
		name : dwr.util.getValue("targetName"),
		antigen : antigen,
		description : dwr.util.getValue("targetDescription")
	};
...
function populateTargets() {
	...
	dwr.util.removeAllRows("targetRows", {
		filter : function(tr) {
...
function deleteTheTarget() {
	...
	if (eleid != "") {
		...
		if (confirm("Are you sure you want to delete this target?")) {
			FunctionalizingEntityManager.deleteTarget(target, function(
					theFunction) {
				if (theFunction != null) {
					currentFunction = theFunction;
				} else {
...
function addFunction(publicRetract, actionName) {
...
function removeFunction(publicRetract, actionName) {
	var validateRetract = true;
	if (publicRetract == "true") {
		validateRetract = confirmPublicDataUpdate();
	}
