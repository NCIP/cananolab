...
<div class="welcomeContent">
	Welcome to the <strong>cancer Nanotechnology Laboratory
		(caNanoLab)</strong> portal. caNanoLab is a data sharing portal designed to
	facilitate information sharing in the biomedical nanotechnology
	research community to expedite and validate the use of nanotechnology
	in biomedicine. caNanoLab allows researchers to share information on
	nanomaterials including the composition of the nanomaterial, the
	functions (e.g. therapeutic, targeting, diagnostic imaging) of the
	nanomaterial, the characterizations of the nanomaterial from
	physico-chemical (e.g. size, molecular weight, surface) and <i>in
		vitro</i> (e.g. cytotoxicity, blood contact) nanomaterial assays, and the
	protocols of these assays. The diagram below illustrates the caNanoLab
	functionality and workflow. Active links are provided on the diagram to
	allow a user to directly navigate to the appropriate function based on
	the authorization level of the user. Function navigation is also
