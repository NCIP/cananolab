	...
	<TBODY>
		...
		<TR>
			<TD class="disclaimerContent" vAlign="top">
				...
				the rapid dissemination of nanomaterial information to the
				...
				below.)&nbsp;&nbsp; By submitting nanomaterial information to
				caNanoLab, you are certifying that you are authorized to release the
				data. &nbsp; You also certify that you will post only data generated
				and/or produced by you or your laboratory, and that you will consult
				with your institution's technology development office before posting
				or disclosing confidential information which may be patentable. You
				may browse, download, and use the data for non-commercial,
				scientific and educational purposes. However, you may encounter
				documents or portions of documents contributed by private
				institutions or organizations. &nbsp;Other parties may retain all
				rights to publish or produce these documents.&nbsp;Commercial use of
				the documents on this site may be protected under United States and
				foreign copyright laws. &nbsp;In addition, some of the data may be
				the subject of patent applications or issued patents, and you may
		...
		<TR>
			<TD class="disclaimerContent" vAlign="top">
				...
				submitting data to the repository. The primary use of the portal is
				to allow the National Cancer Institute to provide a repository as a
				public service to foster the rapid dissemination of nanomaterial
