 ...
 */
public abstract class CaNanoLabServiceClientBase extends ServiceSecurityClient {	
	protected CaNanoLabServicePortType portType;
	...
	public CaNanoLabServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public CaNanoLabServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
