...
public class InvitroNKCellCytotoxicActivityAction extends BaseCharacterizationAction {
	...
	protected void setFormCharacterizationBean(DynaValidatorForm theForm, Characterization aChar) throws Exception {
		NKCellCytotoxicActivityBean charBean=new NKCellCytotoxicActivityBean((NKCellCytotoxicActivity)aChar);
