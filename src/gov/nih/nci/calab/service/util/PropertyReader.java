...
public class PropertyReader
{
    protected static org.apache.log4j.Logger logger_ =
        org.apache.log4j.Logger.getLogger(PropertyReader.class);

     private static Properties myProps = null;
     
     /**
      * This method reads property file, and load all properties 
      * into myProps Properties class by using name/value pair.
      * All property files must reside in gov/nih/nci/calab/resource directory.
      *
...
//             InputStream istream = url.openStream();
             InputStream istream = Thread.currentThread().getContextClassLoader().getResourceAsStream(propertyFileName);
     ...
     /**
      * This method is for users to get property value. It requires users to provide
      * propert file name, and property name.
      * 
      * @param propertyFileName
      * @param propertyName
     ...
     {
         if (myProps == null || (myProps != null && myProps.get(propertyName)== null))
         {
