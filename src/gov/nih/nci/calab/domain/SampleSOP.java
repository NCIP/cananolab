	...
	private static final long serialVersionUID = 1234567890L;
	   ...
	   public void setName( java.lang.String name){
	      this.name = name;
			   ...
			   if(sampleSOPFileCollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	gov.nih.nci.calab.domain.SampleSOP thisIdSet = new gov.nih.nci.calab.domain.SampleSOP();
			         	...
			         	java.util.Collection resultList = applicationService.search("gov.nih.nci.calab.domain.SampleSOPFile", thisIdSet);				 
			      ...
			      {
			      	System.out.println("SampleSOP:getSampleSOPFileCollection throws exception ... ...");
			   		ex.printStackTrace(); 
			      }
			   }	
	   	...
	   	public void setSampleSOPFileCollection(java.util.Collection sampleSOPFileCollection){
