...
public class Run implements java.io.Serializable {
	...
	public gov.nih.nci.calab.domain.Assay getAssay() {
		...
		// gov.nih.nci.calab.domain.Run thisIdSet = new
		// gov.nih.nci.calab.domain.Run();
		// thisIdSet.setId(this.getId());
		//			  
		// try {
		// java.util.List resultList =
		// applicationService.search("gov.nih.nci.calab.domain.Assay",
		// thisIdSet);
	...
	public java.util.Collection getRunSampleContainerCollection() {
		...
		// }catch(Exception ex)
		// {
		// System.out.println("Run:getRunSampleContainerCollection throws
		// exception ... ...");
		// ex.printStackTrace();
		// }
		// }
	...
	public java.util.Collection getInputFileCollection() {
		...
		// thisIdSet.setId(this.getId());
		// java.util.Collection resultList =
		// applicationService.search("gov.nih.nci.calab.domain.InputFile",
		// thisIdSet);
	...
	public java.util.Collection getOutputFileCollection() {
		...
		// thisIdSet.setId(this.getId());
		// java.util.Collection resultList =
		// applicationService.search("gov.nih.nci.calab.domain.OutputFile",
		// thisIdSet);
	...
	public void setOutputFileCollection(
			java.util.Collection outputFileCollection) {
