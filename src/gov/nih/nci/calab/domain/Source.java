			   ...
			   if(contactCollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	gov.nih.nci.calab.domain.Source thisIdSet = new gov.nih.nci.calab.domain.Source();
			         	...
			         	java.util.Collection resultList = applicationService.search("gov.nih.nci.calab.domain.Contact", thisIdSet);				 
			      ...
			      {
			      	System.out.println("Source:getContactCollection throws exception ... ...");
			   		ex.printStackTrace(); 
			      }
			   }	
	   	...
	   	public void setContactCollection(java.util.Collection contactCollection){
			...
			try{
			   if(sampleCollection.size() == 0) {}
			      ...
			      {
			      	System.out.println("Source:getSampleCollection throws exception ... ...");
			   		ex.printStackTrace(); 
			      }
			   }	
