...
public class BuckeyballComposition implements Composition {
	private Long id;
	...
	private String structuralMolecule;
	
	public BuckeyballComposition() {
		super();
		// TODO Auto-generated constructor stub
	}

	public String getStructuralMolecule() {
		return structuralMolecule;
	}

	public void setStructuralMolecule(String structuralMolecule) {
		this.structuralMolecule = structuralMolecule;
	}
