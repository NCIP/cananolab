	...
	private static final long serialVersionUID = 1234567890L;
	   ...
	   public void setName( java.lang.String name){
	      this.name = name;
			   ...
			   if(protocolFileCollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	gov.nih.nci.calab.domain.Protocol thisIdSet = new gov.nih.nci.calab.domain.Protocol();
			         	...
			         	java.util.Collection resultList = applicationService.search("gov.nih.nci.calab.domain.ProtocolFile", thisIdSet);				 
			      ...
			      {
			      	System.out.println("Protocol:getProtocolFileCollection throws exception ... ...");
			   		ex.printStackTrace(); 
			      }
			   }	
	   	...
	   	public void setProtocolFileCollection(java.util.Collection protocolFileCollection){
			...
			try{
			   if(assayCollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	gov.nih.nci.calab.domain.Protocol thisIdSet = new gov.nih.nci.calab.domain.Protocol();
			         	thisIdSet.setId(this.getId());
			         	java.util.Collection resultList = applicationService.search("gov.nih.nci.calab.domain.Assay", thisIdSet);				 
			      ...
			      {
			      	System.out.println("Protocol:getAssayCollection throws exception ... ...");
			   		ex.printStackTrace(); 
			      }
			   }	
