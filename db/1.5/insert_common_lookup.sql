...
insert into common_lookup(attribute,name,value) values ('Cell Counting','instrument','Hemocytometer');
insert into common_lookup(attribute,name,value) values ('Cell Counting','instrument','Coulter Counter');
insert into common_lookup(attribute,name,value) values ('Dynamic Light Scattering','instrument','Dynamic Light Scattering Instrument');
insert into common_lookup(attribute,name,value) values ('Electron Microprobe Analysis','instrument','Electron Microprobe');
insert into common_lookup(attribute,name,value) values ('Electrophoretic Light Scattering','instrument','Electrophoretic Light Scattering Instrument');
insert into common_lookup(attribute,name,value) values ('Energy Dispersive Spectroscopy','instrument','Energy Dispersive Spectrometer');
insert into common_lookup(attribute,name,value) values ('Environmental Transmission Electron Microscopy','instrument','Environmental Transmission Electron Microscope');
insert into common_lookup(attribute,name,value) values ('Coagulation Detection','instrument','Coagulation Monitor');
insert into common_lookup(attribute,name,value) values ('Gas Sorption','instrument','Surface Area and Pore Size Analyzer');
...
insert into common_lookup(attribute,name,value) values ('High Resolution Transmission Electron Microscopy','instrument','Transmission Electron Microscope');
insert into common_lookup(attribute,name,value) values ('Imaging','instrument','Imaging System');
insert into common_lookup(attribute,name,value) values ('Particle Quantitation','instrument','Hemocytometer');
insert into common_lookup(attribute,name,value) values ('Particle Quantitation','instrument','Coulter Counter');
insert into common_lookup(attribute,name,value) values ('Polymerase Chain Reaction','instrument','Thermal Cycler');
insert into common_lookup(attribute,name,value) values ('Powder Diffraction','instrument','Powder Diffractometer');
insert into common_lookup(attribute,name,value) values ('Radiation Quantiation','instrument','Scintillation Counter');
insert into common_lookup(attribute,name,value) values ('Refractometry','instrument','Refractometer');
insert into common_lookup(attribute,name,value) values ('Scanning Auger Spectrometry','instrument','Scanning Auger Spectrometer');
insert into common_lookup(attribute,name,value) values ('Scanning Electron Microscopy','instrument','Scanning Electron Microscope');
insert into common_lookup(attribute,name,value) values ('Scanning Probe Microscopy','instrument','Scanning Probe Microscope');
insert into common_lookup(attribute,name,value) values ('Scanning Tunneling  Microscopy','instrument','Scanning Tunneling Microscope');
...
insert into common_lookup(attribute,name,value) values ('X-Ray Photoelectron Spectroscopy','instrument','X-Ray Photoelectron Spectrometer');
insert into common_lookup(attribute,name,value) values ('Microplate Analysis','instrument','Microplate Reader');
insert into common_lookup(attribute,name,value) values ('Matrix Assisted Laser Desorption Ionisation - Time Of Flight','instrument','MALDI-TOF Mass Spectrometer');
...
insert into common_lookup(attribute,name,value) values ('Gel Filtration Chromatography','instrument','Gel Filtration Column');
