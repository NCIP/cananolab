...
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Analytical Balance');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Atomic Force Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Capillary Electrophoresis Instrument');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Coagulation Monitor');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Confocal Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Control Module');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Coulter Counter');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Dynamic Light Scattering Instrument');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Electron Microprobe');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Electrophoretic Light Scattering Instrument');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Energy Dispersive Spectrometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Environmental Transmission Electron Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Flow Cytometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Fraction Collector');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Gel Filtration Column');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Hemocytometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Imaging System');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'MALDI-TOF Mass Spectrometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Microplate Reader');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Photometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Powder Diffractometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Refractometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Scanning Auger Spectrometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Scanning Electron Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Scanning Probe Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Scanning Tunneling Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Scintillation Counter');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Separation Column');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Spectrophotometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Surface Area and Pore Size Analyzer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Thermal Cycler');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Transmission Electron Microscope');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'X-Ray Photoelectron Spectrometer');
insert into common_lookup (name, attribute, value) values ('Instrument', 'type', 'Zeta Potential Analyzer');
