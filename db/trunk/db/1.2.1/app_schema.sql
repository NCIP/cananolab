...
create table assay (
  assay_pk_id bigint not null,
  assay_name varchar(200) null,
  description varchar(4000) null,
  assay_type varchar(200) null,
  created_date datetime null,
  created_by varchar(200) null,
  protocol_pk_id bigint null,
...
create table def_assay_type (
  assay_type_pk_id bigint not null,
  name varchar(200) not null,
  description varchar(4000) null,
  execute_order varchar(10) null,
...
create table run (
  run_pk_id bigint not null,
  run_name varchar(500) null,
  description varchar(4000) null,
  created_by varchar(200) null,
  created_date datetime null,
  assay_pk_id bigint null,
  run_by varchar(200) null,
...
create table run_sample_container (
  ...
  run_sample_container_pk_id bigint not null,
  created_by varchar(200) null,
  created_date datetime null,
  run_pk_id bigint null,
