...
INSERT INTO `cananolab121`.`assay`(`assay_pk_id`, `assay_name`, `description`, `assay_type`, `created_date`, `created_by`, `protocol_pk_id`)
...
INSERT INTO `cananolab121`.`def_activation_method`(`activation_method_pk_id`, `name`)
VALUES (1, 'MRI'),
  (2, 'NMR'),
  (3, 'Radiation'),
  (4, 'Ultrasound'),
...
INSERT INTO `cananolab121`.`def_assay_type`(`assay_type_pk_id`, `name`, `description`, `execute_order`)
VALUES (1, 'Pre-screening', NULL, '1'),
  (2, 'In Vitro', NULL, '2'),
  (3, 'In Vivo', NULL, '3'),
  (4, 'PCC', NULL, '4');

INSERT INTO `cananolab121`.`def_bioassay_data_category`(`category_pk_id`, `name`, `characterization_name`)
...
INSERT INTO `cananolab121`.`def_bond_type`(`bond_type_pk_id`, `name`)
VALUES (1, 'Covalent'),
  (2, 'Vander Walls'),
  (3, 'Ionic'),
  (4, 'Non-specific');

INSERT INTO `cananolab121`.`def_cellline_type`(`cellline_type_pk_id`, `name`)
VALUES (1, 'Human Hepatocarinma'),
  (2, 'Porcine Renal Tubule');

INSERT INTO `cananolab121`.`def_characterization_category`(`char_category_pk_id`, `category`, `name`, `has_action`, `category_order`, `indent_level`, `name_abbreviation`)
...
INSERT INTO `cananolab121`.`def_characterization_file_type`(`file_type_pk_id`, `name`)
VALUES (1, 'Image'),
  (2, 'Graph'),
  (3, 'SpreadSheet');

INSERT INTO `cananolab121`.`def_datum_name`(`datum_name_pk_id`, `name`, `is_datum_parsed`, `characterization_name`)
VALUES (1, 'PDI', 0, 'Size'),
  (2, 'Z-Average', 0, 'Size'),
  (3, 'Peak 1', 0, 'Size'),
  (4, 'RMS Size', 0, 'Size'),
...
INSERT INTO `cananolab121`.`def_function_agent_target_type`(`agent_target_type_pk_id`, `name`)
VALUES (1, 'Receptor'),
  (2, 'Antigen');

INSERT INTO `cananolab121`.`def_function_agent_type`(`agent_type_pk_id`, `name`)
VALUES (1, 'Peptide'),
  (2, 'Small Molecule'),
  (3, 'Antibody'),
  (4, 'DNA'),
...
INSERT INTO `cananolab121`.`def_function_linkage_type`(`linkage_type_pk_id`, `name`)
VALUES (1, 'Attachment'),
  (2, 'Encapsulation');

INSERT INTO `cananolab121`.`def_function_type`(`function_type_pk_id`, `name`)
VALUES (1, 'Therapeutic'),
  (2, 'Targeting'),
  (3, 'Diagnostic Imaging'),
  (4, 'Diagnostic Reporting');

INSERT INTO `cananolab121`.`def_image_contrast_agent_type`(`agent_type_pk_id`, `name`)
...
INSERT INTO `cananolab121`.`def_measure_type`(`measure_type_pk_id`, `name`)
VALUES (5, 'threshold'),
  (6, 'boolean'),
  (1, 'mean'),
  (2, 'median'),
...
INSERT INTO `cananolab121`.`def_measure_unit`(`measure_unit_pk_id`, `unit_name`, `description`, `unit_type`)
...
INSERT INTO `cananolab121`.`def_molecular_formula_type`(`molecular_formula_type_pk_id`, `name`)
VALUES (1, 'SMILES'),
  (2, 'SMARTS');

INSERT INTO `cananolab121`.`def_morphology_type`(`morphology_type_pk_id`, `name`)
VALUES (1, 'Powder'),
  (2, 'Liquid'),
  (3, 'Solid'),
  (4, 'Crystalline'),
...
INSERT INTO `cananolab121`.`def_protocol_type`(`protocol_type_pk_id`, `name`)
...
INSERT INTO `cananolab121`.`def_sample_type`(`sample_type_pk_id`, `name`)
...
INSERT INTO `cananolab121`.`def_shape_type`(`shape_type_pk_id`, `name`)
VALUES (1, 'Composite'),
  (2, 'Cubic'),
  (3, 'Cylinder'),
  (4, 'Elliptical'),
...
INSERT INTO `cananolab121`.`def_solvent_type`(`solvent_type_pk_id`, `name`)
VALUES (1, 'Pooled Blood Serum (PBS)'),
  (2, 'Saline '),
  (3, 'Water');

INSERT INTO `cananolab121`.`def_species_name`(`species_name_pk_id`, `name`)
VALUES (1, 'Cat'),
  (2, 'Cattle'),
  (3, 'Dog'),
  (4, 'Goat'),
...
INSERT INTO `cananolab121`.`def_storage_type`(`storage_type_id`, `name`)
VALUES (1, 'Lab'),
  (2, 'Room'),
  (3, 'Freezer'),
  (4, 'Shelf'),
...
INSERT INTO `cananolab121`.`def_surface_group_type`(`surface_group_type_pk_id`, `name`)
VALUES (1, 'Amine'),
  (2, 'Carboxyl'),
  (3, 'Hydroxyl');

INSERT INTO `cananolab121`.`def_wall_type`(`wall_type_pk_id`, `name`)
VALUES (1, 'SWNT'),
  (2, 'DWNT'),
  (3, 'MWNT');

INSERT INTO `cananolab121`.`hibernate_unique_key`(`next_hi`)
VALUES (113);

INSERT INTO `cananolab121`.`instrument`(`instrument_pk_id`, `type`, `abbreviation`, `manufacturer`)
...
INSERT INTO `cananolab121`.`lab_file`(`file_pk_id`, `file_name`, `file_uri`, `file_type_extension`, `file_source_type`, `version`, `status`, `reason`, `created_by`, `created_date`, `sample_sop_pk_id`, `run_pk_id`, `data_status_pk_id`, `title`, `description`, `comments`, `type`)
...
INSERT INTO `cananolab121`.`sample_sop`(`sample_sop_pk_id`, `description`, `sop_name`)
