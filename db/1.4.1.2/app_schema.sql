...
;
DROP TABLE IF EXISTS other_nanoparticle_entity
;
...
;
DROP TABLE IF EXISTS nanoparticle_entity
;
DROP TABLE IF EXISTS functionalizing_entity
;
DROP TABLE IF EXISTS composition_lab_file
;
DROP TABLE IF EXISTS sample_management
;
DROP TABLE IF EXISTS nanoparticle_sample_publication
;
DROP TABLE IF EXISTS derived_datum
;
DROP TABLE IF EXISTS composition
;
DROP TABLE IF EXISTS chemical_association_lab_file
;
...
;
DROP TABLE IF EXISTS nanoparticle_sample
;
DROP TABLE IF EXISTS nanoparticle_entity_lab_file
;
DROP TABLE IF EXISTS keyword_nanoparticle_sample
;
DROP TABLE IF EXISTS keyword_lab_file
;
DROP TABLE IF EXISTS instrument_config
;
DROP TABLE IF EXISTS functionalizing_entity_lab_file
;
...
(
	...
	start_page VARCHAR(200) NULL,
	end_page VARCHAR(200) NULL,
	year INTEGER NULL,
