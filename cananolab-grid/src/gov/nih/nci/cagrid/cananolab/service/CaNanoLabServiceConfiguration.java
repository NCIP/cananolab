 ...
 * 
 */
public class CaNanoLabServiceConfiguration implements ServiceConfiguration {

	public static CaNanoLabServiceConfiguration  configuration = null;
    public String etcDirectoryPath;
    	
	public static CaNanoLabServiceConfiguration getConfiguration() throws Exception {
		if (CaNanoLabServiceConfiguration.configuration != null) {
			return CaNanoLabServiceConfiguration.configuration;
		}
		...
		try {
			...
			CaNanoLabServiceConfiguration.configuration = (CaNanoLabServiceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
