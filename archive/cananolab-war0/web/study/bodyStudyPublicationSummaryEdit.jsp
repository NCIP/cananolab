			...
			<table width="100%" align="center" class="summaryViewLayer3">
				<tr>
					...
					<th valign="top" align="right" width="80%">
						<a href="publication.do?page=0&dispatch=setupUpdate&publicationId=11042860">Edit</a>
					</th>
				</tr>
				<tr>
		...
		<td>
			<table width="100%" align="center" class="summaryViewLayer3">
				<tr>
					...
					<th valign="top" align="right" width="80%">
						<a href="publication.do?page=0&dispatch=setupUpdate&publicationId=11042874">Edit</a>
					</th>
				</tr>
				<tr>
					<td class="cellLabel" width="20%">
